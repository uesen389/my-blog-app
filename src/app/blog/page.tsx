...
export default async function BlogPage({ searchParams }: { searchParams: Promise<{ category?: string; archive?: string }> }) {
  const posts = await getPostList();
  const { category: selectedCategory, archive: selectedArchive } = await searchParams;
  ...
  // Append any categories not in desiredOrder, sorted alphabetically, if any
